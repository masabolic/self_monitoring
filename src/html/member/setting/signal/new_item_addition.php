    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="radio" name="signal" id="yellow" value="1">
                <label for="yellow">黄</label>
                <input type="radio" name="signal" id="add_yellow" value="2">
                <label for="add_yellow">追加黄</label>
                <input type="radio" name="signal" id="add_orenge" value="3">
                <label for="add_orenge">追加橙</label>
                <input type="radio" name="signal" id="add_red" value="4">
